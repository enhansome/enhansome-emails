...
* [Postal](https://github.com/atech/postal) ⭐ 16,795 | 🐛 95 | 🌐 Ruby | 📅 2026-09-05 - A fully featured open source mail delivery platform for incoming & outgoing e-mail.
...
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,972 | 🐛 257 | 🌐 Python | 📅 2026-09-04 - Self-hosted email alias solution.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,142 | 🐛 256 | 🌐 Go | 📅 2024-02-13 A local fake SMTP server (based on Go).
...
* [Web Configs](https://github.com/jonathandion/web-configs) ⭐ 28 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-05 - Monorepo for all common configurations for building web apps.
