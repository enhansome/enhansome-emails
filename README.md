...
* [Foundation for Emails](https://github.com/zurb/foundation-emails) ⭐ 7,794 | 🐛 3 | 🌐 HTML | 📅 2026-03-13 - Quickly create responsive HTML emails that work on any device & client. Even Outlook.
...
* [Cerberus](https://github.com/TedGoas/Cerberus) ⭐ 5,136 | 🐛 13 | 🌐 HTML | 📅 2026-09-14 - Few responsive email patterns.
...
* [Antwort](https://github.com/internations/antwort) ⭐ 3,561 | 🐛 3 | 🌐 HTML | 📅 2020-09-30 - Antwort offers responsive layouts for Email that both fits and adapts to client widths.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,623 | 🐛 26 | 🌐 Go | 📅 2026-09-15 - A tool for email verification without sending any emails.
...
* [Postal](https://github.com/atech/postal) ⭐ 16,822 | 🐛 95 | 🌐 Ruby | 📅 2026-09-19 - A fully featured open source mail delivery platform for incoming & outgoing e-mail.
...
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,999 | 🐛 259 | 🌐 Python | 📅 2026-09-23 - Self-hosted email alias solution.
...
* [Email marketing regulations](https://github.com/threeheartsdigital/email-marketing-regulations) ⭐ 470 | 🐛 0 | 📅 2026-07-23 - A guide to email marketing regulations around the world.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,165 | 🐛 256 | 🌐 Go | 📅 2024-02-13 A local fake SMTP server (based on Go).
...
If you want to contribute, please read the [contribution guidelines](https://github.com/jonathandion/awesome-emails/blob/master/contributing.md) ⭐ 2,747 | 🐛 51 | 📅 2024-10-03.
...
* [Web Configs](https://github.com/jonathandion/web-configs) ⭐ 28 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-21 - Monorepo for all common configurations for building web apps.
