...
* [Cerberus](https://github.com/TedGoas/Cerberus) ⭐ 5,133 | 🐛 13 | 🌐 HTML | 📅 2024-07-16 - Few responsive email patterns.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,614 | 🐛 21 | 🌐 Go | 📅 2026-09-09 - A tool for email verification without sending any emails.
...
* [Postal](https://github.com/atech/postal) ⭐ 16,797 | 🐛 95 | 🌐 Ruby | 📅 2026-09-05 - A fully featured open source mail delivery platform for incoming & outgoing e-mail.
...
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,974 | 🐛 259 | 🌐 Python | 📅 2026-09-04 - Self-hosted email alias solution.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,146 | 🐛 256 | 🌐 Go | 📅 2024-02-13 A local fake SMTP server (based on Go).
...
If you want to contribute, please read the [contribution guidelines](https://github.com/jonathandion/awesome-emails/blob/master/contributing.md) ⭐ 2,744 | 🐛 48 | 📅 2024-10-03.
...
* [Web Configs](https://github.com/jonathandion/web-configs) ⭐ 28 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-08 - Monorepo for all common configurations for building web apps.
